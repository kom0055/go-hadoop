...
type BlockWithLocationsProto struct {
	...
	StorageTypes  []client.StorageTypeProto `protobuf:"varint,4,rep,name=storageTypes,enum=hadoop.hdfs.StorageTypeProto" json:"storageTypes,omitempty"`
...
var file_HdfsServer_proto_rawDesc = []byte{
	...
	0x52, 0x41, 0x52, 0x59, 0x10, 0x04, 0x42, 0x65, 0x0a, 0x25, 0x6f, 0x72, 0x67, 0x2e, 0x61, 0x70,
	...
	0x73, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x6f,
	0x6d, 0x30, 0x30, 0x35, 0x35, 0x2f, 0x67, 0x6f, 0x2d, 0x68, 0x61, 0x64, 0x6f, 0x6f, 0x70, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x64, 0x66, 0x73, 0xa0, 0x01, 0x01,
}
...
var file_HdfsServer_proto_goTypes = []interface{}{
	...
	(*client.BlockProto)(nil),                        // 20: hadoop.hdfs.BlockProto
	(client.StorageTypeProto)(0),                     // 21: hadoop.hdfs.StorageTypeProto
	(*client.LocatedBlockProto)(nil),                 // 22: hadoop.hdfs.LocatedBlockProto
	(*client.ErasureCodingPolicyProto)(nil),          // 23: hadoop.hdfs.ErasureCodingPolicyProto
}
