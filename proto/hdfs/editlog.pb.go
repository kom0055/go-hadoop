...
var file_editlog_proto_rawDesc = []byte{
	...
	0x06, 0x78, 0x41, 0x74, 0x74, 0x72, 0x73, 0x42, 0x62, 0x0a, 0x25, 0x6f, 0x72, 0x67, 0x2e, 0x61,
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x64, 0x66, 0x73, 0xa0, 0x01, 0x01,
}
...
var file_editlog_proto_goTypes = []interface{}{
	...
	(*client.AclEntryProto)(nil), // 2: hadoop.hdfs.AclEntryProto
	(*client.XAttrProto)(nil),    // 3: hadoop.hdfs.XAttrProto
}
